...
set(CMAKE_C_FLAGS "-mcpu=${MCU_SPEC} -DSTM32F407xx -mthumb -mfloat-abi=hard -mfpu=fpv4-sp-d16 -g -O2 -Wno-write-strings -fno-builtin")
set(CMAKE_CXX_FLAGS "-mcpu=${MCU_SPEC} -DSTM32F407xx -mthumb -mfloat-abi=hard -mfpu=fpv4-sp-d16 -g -std=c++11 -fno-exceptions -fno-rtti -O2 -Wno-write-strings -Wno-endif-labels -fno-builtin")
set(CMAKE_EXE_LINKER_FLAGS "-T${LINKER_SCRIPT} -mcpu=${MCU_SPEC} --specs=nano.specs -Wl,--gc-sections -O2")
