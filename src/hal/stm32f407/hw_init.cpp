...
#define CS_M_Pin GPIO_PIN_5
#define CS_M_GPIO_Port GPIOE
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOE, CS_I2C_SPI_Pin|CS_A_Pin|CS_M_Pin|GPIO_PIN_6, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : CS_A_Pin CS_M_Pin */
  GPIO_InitStruct.Pin = CS_A_Pin|CS_M_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
